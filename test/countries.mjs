...
export default deep.flatten(
  countries.map(country => [
    ...
    {
      fn: country.alt,
      expect: t => is.str(t) || is.undef(t) || is.objectNative(t),
      info: `.slug of ${country.name} is a string`,
    },
    ...
    {
      fn: slugify(country.name),
      expect: country.slug,
      info: `.slug o ${country.name} is slugified correctly`,
    },
  ]),
)
